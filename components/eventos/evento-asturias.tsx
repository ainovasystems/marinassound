...
interface EventoAsturiasProps {
  evento: any
}

export function EventoAsturias({ evento }: EventoAsturiasProps) {
  return (
    <>
      <EventHeader 
        eventoId="asturias" 
        urlEntradas={evento.urlEntradas}
        mostrarBotonAutorizacion={false}
      />
      ...
      <div className="pt-32 pb-16 min-h-screen flex flex-col items-center justify-start px-4 bg-gradient-to-b from-navy-900 to-navy-950">
        <div className="max-w-4xl w-full space-y-12 relative">
          ...
          <div className="mt-8">
            ...
            {/* Botones de acción */}
            <div className="flex flex-col md:flex-row gap-6 items-center justify-center pt-8 w-full">
              ...
              {evento.urlAutorizacionMenores && evento.enableAutorizacion && (
                <div className="w-full md:w-auto">
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="border-blue-500 text-white hover:bg-blue-900/40 hover:border-blue-400 hover:text-white font-medium px-8 py-7 text-lg font-display w-full md:w-auto bg-navy-800/50 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2"
                  >
                    <a href={evento.urlAutorizacionMenores} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
                      <span>Autorización de menores</span>
                    </a>
                  </Button>
                </div>
              )}
